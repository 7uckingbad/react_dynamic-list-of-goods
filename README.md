...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://7uckingbad.github.io/react_dynamic-list-of-goods/) and add it to the PR description.
